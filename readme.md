...
- Testes manuais: obviamente, testes manuais não são possiveis. para isso a *entrega contínua* é mais adequada. Na prática, você utlizaria somente os três primeiros passos, deixando o deploy de produção para outro momento.

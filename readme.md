# Deploy contínuo de aplicações [Laravel 5](http://laravel.com/) na [Umbler](https://www.umbler.com) utilizado [Snap CI](https://snap-ci.com)
...
Nosso pipeline de implatação vai consistir em 4 etapas:
